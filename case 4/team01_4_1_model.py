...
# Create a new model
model = gp.Model('team01_4_1_model')
...
# Create .lp file
model.write('team01_4_1_model.lp')
...
# Plotting and Save the plot in directory
fig = ff.create_gantt(df, index_col='Resource', show_colorbar=True, group_tasks=True, showgrid_x=True, title='Single-Machine Scheduling: Minimum Average Completion Time')
fig.update_layout(margin=dict(l=60, r=50, t=100, b=300))

output_dir = "Gantt_Chart"
os.makedirs(output_dir, exist_ok=True)

output_file = os.path.join(output_dir, "team01_4_1_MACT.html")
fig.write_html(output_file)
fig.write_html("Gantt_Chart/team01_4_1_MACT.html")
